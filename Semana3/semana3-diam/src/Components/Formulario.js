        ...
        <div>
            ...
            <form onSubmit={checkComment} autoComplete="on">
                ...
                <input
                    ...
                    id="contacto"
                    name="contacto"
                    pattern="(\+[0-9]{0,3}\s?)?([0-9]\s?)+"
                    required
                /><br /><br />
                <label>Dias disponível:</label><br />
                <input type="checkbox" id="dia1" name="dia1" />
                <label htmlFor="dia1">21 de agosto de manhã</label><br />
                <input type="checkbox" id="dia2" name="dia2" />
                <label htmlFor="dia2">21 de agosto de tarde</label><br />
                <input type="checkbox" id="dia3" name="dia3" />
                <label htmlFor="dia3">22 de agosto de manhã</label><br />
                <input type="checkbox" id="dia4" name="dia4" />
                <label htmlFor="dia4">22 de agosto de tarde</label><br />
                <input type="checkbox" id="dia5" name="dia5" />
                <label htmlFor="dia5">23 de agosto de manhã</label><br />
                <input type="checkbox" id="dia6" name="dia6" />
                <label htmlFor="dia6">23 de agosto de tarde</label><br />
                <input type="checkbox" id="dia7" name="dia7" />
                <label htmlFor="dia7">24 de agosto de manhã</label><br />
                <input type="checkbox" id="dia8" name="dia8" />
                <label htmlFor="dia8">24 de agosto de tarde</label><br /><br />
